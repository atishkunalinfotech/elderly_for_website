...
class GroupMembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_membership" do
    assert_difference('GroupMembership.count') do
      post group_memberships_url, params: { group_membership: { group_id: @group_membership.group_id, group_name: @group_membership.group_name, user_id: @group_membership.user_id } }
    end
  ...
  test "should update group_membership" do
    patch group_membership_url(@group_membership), params: { group_membership: { group_id: @group_membership.group_id, group_name: @group_membership.group_name, user_id: @group_membership.user_id } }
